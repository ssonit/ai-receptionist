...
## Corpus Check
- 679 files · ~446,496 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3667 nodes · 7797 edges · 419 communities (199 shown, 220 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 65 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a74d5046`
...
1. `cn()` - 311 edges
2. `createAdminClient()` - 140 edges
3. `appErrorMessage()` - 69 edges
4. `createClient()` - 65 edges
5. `requireOwnerWorkspace()` - 49 edges
6. `Button()` - 45 edges
7. `APP_ERROR_CODE` - 37 edges
8. `getDashboardUser()` - 34 edges
9. `react` - 34 edges
...
## Communities (419 total, 220 thin omitted)
...
Cohesion: 0.09
Nodes (37): ChatUser, ConversationDetailSheet(), ConversationToolErrors(), ConversationTranscript(), DetailPayload, HeaderAction, headerReducer(), HeaderState (+29 more)
...
Cohesion: 0.07
Nodes (55): POST(), processEvent(), RELEVANT_EVENTS, verifySignature(), webhookToBookingItem(), CAL_BOOKING_LIST_FILTERS, CAL_BOOKING_VIEWS, CalBookingLifecycleStatus (+47 more)
...
Cohesion: 0.14
Nodes (18): generatedFaqSchema, GenerateFaqDraftState, parseFaqItems(), saveFaqSettings(), mocks, AppErrorCode, AppError, faqItemInvalidMessage() (+10 more)

### Community 19 - "tool.tsx"
Cohesion: 0.05
Nodes (57): ChatSessionSidebar(), metadata, mono, RootLayout(), sans, VirtualConversation(), AnalyticsTrendChart(), ChartAreaInteractive() (+49 more)
...
Cohesion: 0.10
Nodes (44): execute(), execute(), execute(), AdminClient, bumpAttemptLock(), checkAttemptLock(), execute(), authorize() (+36 more)
...
Cohesion: 0.11
Nodes (24): signOut(), ChatUserMenu(), getInitials(), getInitials(), NavUser(), SetupShell(), Avatar(), AvatarBadge() (+16 more)

### Community 32 - "20260722000008_bookings_list_status.sql"
Cohesion: 0.15
Nodes (15): CalConnectionCard(), Props, MessengerConnectionCard(), Props, Props, WebhookSecretCard(), Props, ZaloConnectionCard() (+7 more)
...
Cohesion: 0.15
Nodes (21): GET(), parseCursor(), NotificationsPage(), formatWhen(), GroupFilter, NotificationsInbox(), severityClass(), ViewMode (+13 more)
...
Cohesion: 0.31
Nodes (13): MeetingTypesForm(), createMeetingTypeAction(), MeetingTypesActionState, mirrorRow(), revalidateMeetingTypePaths(), setAiBookingMeetingTypeAction(), setAiBookingOnWorkspace(), syncMeetingTypesAction() (+5 more)
...
Cohesion: 0.14
Nodes (6): Dialog(), CheckResult, ToolResult, mockBooking, ToolResult, SupabaseMock
...
Cohesion: 0.16
Nodes (19): AccountProfileForm(), AccountPage(), AnalyticsPage(), ConversationsPage(), HelpPage(), LeadsPage(), DashboardPage(), daysAgoIso() (+11 more)
...
Cohesion: 0.22
Nodes (25): POST(), GET(), Params, POST(), GET(), Params, PATCH(), GET() (+17 more)

### Community 68 - "client.ts"
Cohesion: 0.26
Nodes (13): buildZaloOAuthUrl(), chunkZaloText(), exchangeZaloCode(), getZaloOaProfile(), connectZaloWorkspace(), postToken(), refreshZaloToken(), sendOneZaloText() (+5 more)
...
Cohesion: 0.15
Nodes (21): AgentChat(), cookieNameFor(), LocaleCtx, LocaleKind, LocaleProvider(), LocaleToggle(), readCookie(), useAppLocale() (+13 more)
...
Cohesion: 0.24
Nodes (8): DashboardLayout(), BookingLiveBanner(), DashboardBookingPathContext, DashboardBookingPathProvider(), DashboardRoleContext, DashboardRoleProvider(), useDashboardRole(), readDashboardLocale()
...
Cohesion: 0.10
Nodes (22): GET(), GET(), forgotPassword(), AuthShell(), highlights, InviteAcceptPanel(), ForgotPasswordForm(), initial (+14 more)

### Community 94 - "use-stick-to-bottom"
Cohesion: 0.12
Nodes (21): AuthState, resetPassword(), signIn(), signUp(), initial, LoginForm(), initial, SignupForm() (+13 more)
...
Cohesion: 0.21
Nodes (12): generateMetadata(), PageProps, PublicBookingSlugPage(), ChatPage(), LandingPage(), WorkspaceBookingPage(), EmbedChat(), HomePage() (+4 more)
...
Cohesion: 0.14
Nodes (31): absoluteInviteUrl(), copyLink(), initial, WorkspaceTeamCard(), saveEmbedAllowedOrigins(), generateFaqDraftAction(), LeadActionState, requireWorkspace() (+23 more)
...
Cohesion: 0.06
Nodes (35): AgentChatInner(), AgentChatThread(), AgentStatus, encodePollCursor(), StatusDot(), ThreadBootstrap, ChatSessionDrawer(), ChatSessionsToggle() (+27 more)

### Community 117 - "app/layout.tsx"
Cohesion: 0.19
Nodes (18): EmbedPageClient(), EmbedDashboardPage(), EmbedPage(), metadata, PageProps, absoluteAppOrigin(), appOrigin(), buildEmbedSnippets() (+10 more)

### Community 118 - "conversations/page.tsx"
Cohesion: 0.13
Nodes (21): GET(), Params, redactBookingSecrets(), redactBookingSecretsDeep(), actorOwnsSession(), ChatMessageRow, ChatMessagesPage, ChatSessionListItem (+13 more)

### Community 123 - "leads-table.tsx"
Cohesion: 0.09
Nodes (38): AiHealthPanel(), severityClass(), severityIcon(), Props, chartData, Card(), CardAction(), CardContent() (+30 more)

### Community 124 - "dashboard-access.ts"
Cohesion: 0.18
Nodes (17): GET(), normalizeQuery(), uniqueById(), GET(), AccountActionState, updateAccountNameAction(), markAllNotificationsReadAction(), markNotificationReadAction() (+9 more)

### Community 125 - "hover-card.tsx"
Cohesion: 0.15
Nodes (20): authorize(), POST(), isDefinitiveCalOAuthError(), { refreshAccessToken }, seedOAuthWorkspace(), assertWorkspaceSubscriptionActive(), ensureWebhookSecret(), generateWebhookSecret() (+12 more)
...
Cohesion: 0.07
Nodes (41): DetailRow(), SortableSuggestionChip(), chartData, columns, schema, ShimmerButton, ShimmerButtonProps, BreadcrumbEllipsis() (+33 more)
...
Cohesion: 0.13
Nodes (39): execute(), execute(), execute(), execute(), execute(), activeBooking(), AgentAuthBag, assertBookingChangeAllowed() (+31 more)
...
Cohesion: 0.05
Nodes (56): AGENT_ABOUT_TEMPLATES, AGENT_HOURS_PRESETS, AGENT_INSTRUCTIONS_STARTERS, AgentAboutTemplate, AgentHoursPreset, AgentInstructionsStarter, AGENT_REPLY_LOCALE_OPTIONS, AGENT_REPLY_LOCALES (+48 more)
...
Cohesion: 0.20
Nodes (16): BillingPayClient(), PaymentStatus, AgentPage(), BillingPayPage(), FaqPage(), SetupPage(), AppSidebar(), parseChatSuggestions() (+8 more)
...
Cohesion: 0.18
Nodes (9): getChannelActor(), channelVisitorId(), MessengerMessageEvent, MetaEntry, MetaMessagingEntry, MetaWebhookBody, parseMessengerEvents(), verifyMessengerSignature() (+1 more)
...
### Community 350 - "book_appointment.test.ts"
Cohesion: 0.42
Nodes (8): optionalText(), parseSuggestionsFromForm(), saveWorkspaceAgent(), parseAgentReplyLocale(), parseAgentTone(), suggestionInvalidMessage(), suggestionRequiredMessage(), bookingRoute()
...
Cohesion: 0.32
Nodes (5): REMINDER_STATUS_RANK, NewBookingDialog(), NewBookingMeetingType, SlotOption, todayIso()

### Community 369 - "sonner"
Cohesion: 0.07
Nodes (45): FaqSettingsForm(), initial, toDraftItems(), CreateMeetingTypeSheet(), extractDescription(), extractLocationLabel(), formatDateTime(), formatDuration() (+37 more)
...
### Community 377 - "@tabler/icons-react"
Cohesion: 0.33
...
### Community 395 - "eve-logo.tsx"
Cohesion: 0.32
Nodes (3): LegalPage(), metadata, metadata

### Community 396 - "createAdminClient"
Cohesion: 0.22
...
### Community 409 - "bookings/actions.ts"
Cohesion: 0.20
Nodes (18): createManualBookingAction(), getAvailableSlotsAction(), requireStaff(), resolveEventRef(), syncBookingsAction(), SyncBookingsState, MeetingTypesPage(), BookingsSyncButton() (+10 more)

### Community 411 - "invite-accept-panel.tsx"
Cohesion: 0.18
Nodes (26): WorkspaceSettingsForm(), checkWorkspaceSlugAvailable(), optionalText(), saveWorkspaceSettings(), completeSetupAction(), disconnectCalAction(), finishSetupAction(), saveCalApiKeyAction() (+18 more)
...
## Knowledge Gaps
- **1452 isolated node(s):** `Goal`, `Non-goals`, ``lib/booking-cancel.ts` (new)`, ``app/dashboard/bookings/actions.ts` (extend)`, `No notification on staff-initiated cancel` (+1447 more)
...
- **Why does `cn()` connect `chat-sessions.ts` to `prompt-input.tsx`, `message.tsx`, `code-block.tsx`, `conversation-detail-sheet.tsx`, `landing-page.tsx`, `sidebar.tsx`, `data-table.tsx`, `command.tsx`, `tool.tsx`, `layout.tsx`, `models.ts`, `invite-accept-panel.tsx`, `conversation.tsx`, `dependencies`, `20260722000004_workspace_faq_sections.sql`, `@dnd-kit/modifiers`, `radix-ui`, `app/layout.tsx`, `workspace-settings-form.tsx`, `badge.tsx`, `use-stick-to-bottom`, `workspace-agent-studio.tsx`, `shimmer-button.tsx`, `sonner`, `seed.sql`, `@tabler/icons-react`, `leads-table.tsx`, `dashboard-access.ts`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `react` connect `tool.tsx` to `dependencies`, `next-themes`, `conversation-detail-sheet.tsx`, `shimmer-button.tsx`, `data-table.tsx`, `leads-table.tsx`, `app/layout.tsx`, `seed.sql`, `invite-accept-panel.tsx`, `dashboard-access.ts`, `20260723000005_leads_status.sql`, `@dnd-kit/modifiers`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `dependencies` connect `20260723000005_leads_status.sql` to `workspace-secrets.ts`, `@shikijs/engine-oniguruma`, `slugify`, `class-variance-authority`, `app/layout.tsx`, `@streamdown/code`, `next-themes`, `posthog-node`, `use-stick-to-bottom`, `@vvo/tzdb`, `@tabler/icons-react`, `Smoke Checklist`, `@dnd-kit/core`, `@streamdown/cjk`, `@dnd-kit/sortable`, `@dnd-kit/modifiers`, `tool.tsx`, `react-is`, `nanoid`, `@dnd-kit/core`, `next-intl`, `@tailwindcss/postcss`, `lenis`, `@ai-sdk/google`, `motion`, `react-dom`, `recharts`, `@supabase/ssr`, `tailwind-merge`, `@dnd-kit/sortable`, `@vercel/connect`, `ai`, `@dnd-kit/modifiers`, `write_file.ts`, `recharts`, `streamdown`, `@dnd-kit/utilities`, `class-variance-authority`, `lucide-react`, `@dnd-kit/core`, `tailwindcss`, `signOut`, `clsx`, `@shikijs/core`, `particles.tsx`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **What connects `Goal`, `Non-goals`, ``lib/booking-cancel.ts` (new)` to the rest of the system?**
