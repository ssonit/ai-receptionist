...
## Corpus Check
- 519 files · ~378,601 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2806 nodes · 5661 edges · 358 communities (153 shown, 205 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 50 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fd7833f1`
...
## Communities (358 total, 205 thin omitted)
...
Cohesion: 0.07
Nodes (20): features, Hero(), LandingPage(), logos, PlanFeature, plans, Pricing(), Marquee() (+12 more)
...
Cohesion: 0.08
Nodes (37): AppSidebar(), DashboardCommandContext, DashboardCommandContextValue, DashboardCommandProvider(), useDashboardCommand(), DashboardCommand(), NavMain(), NavMainGroup (+29 more)

### Community 12 - "utils.ts"
Cohesion: 0.08
Nodes (43): ChatUser, BookingDetailSheet(), BookingRow, BookingsTable(), bookingTitle(), extractEndIso(), extractMeetingUrl(), formatDay() (+35 more)
...
Cohesion: 0.06
Nodes (70): EveAuth, withTenantAttributes(), POST(), GET(), Params, POST(), GET(), Params (+62 more)
...
Cohesion: 0.17
Nodes (24): execute(), nextStatusOnLog(), authorize(), GET(), workspaceIdsForTick(), normalizeLeadUrgency(), findWorkspaceLead(), upsertLeadAsBooked() (+16 more)
...
Cohesion: 0.40
Nodes (8): AgentPage(), FaqPage(), parseAgentReplyLocale(), parseAgentTone(), parseChatSuggestions(), withWorkspaceAiDefaults(), mapWorkspaceFaqRecord(), fetchWorkspaceFaqForUser()

### Community 25 - "login-form.tsx"
Cohesion: 0.21
Nodes (21): execute(), TimezoneSelect(), authAttr(), ABBREV, formatInZone(), formatSlotForGuest(), isValidIanaTimeZone(), normalizeIanaTimeZone() (+13 more)
...
Cohesion: 0.34
Nodes (13): MeetingTypesForm(), createMeetingTypeAction(), MeetingTypesActionState, mirrorRow(), requireWorkspaceId(), revalidateMeetingTypePaths(), setAiBookingMeetingTypeAction(), setAiBookingOnWorkspace() (+5 more)
...
Cohesion: 0.10
Nodes (31): confirmReminderOptOutAction(), UnsubscribeActionState, PageProps, ReminderUnsubscribePage(), initialState, UnsubscribeConfirmForm(), appOrigin(), addCalendarDays() (+23 more)
...
Cohesion: 0.15
Nodes (18): generateMetadata(), PageProps, PublicBookingSlugPage(), ChatPage(), AgentChat(), EmbedChat(), EmbedPage(), metadata (+10 more)
...
### Community 46 - "react"
Cohesion: 0.16
Nodes (29): addDaysYmd(), compareYmd(), todayYmd(), toYmd(), execute(), execute(), MeetingTypesPage(), bookingConfig (+21 more)
...
Cohesion: 0.27
Nodes (10): optionalText(), parseSuggestionsFromForm(), requireWorkspaceId(), saveWorkspaceAgent(), APP_ERROR_CODE, AppErrorCode, suggestionInvalidMessage(), suggestionRequiredMessage() (+2 more)

### Community 55 - "bookings-table.tsx"
Cohesion: 0.32
Nodes (12): WorkspaceSettingsForm(), checkWorkspaceSlugAvailable(), optionalText(), requireWorkspaceId(), saveWorkspaceSettings(), reminderLeadTooShortMessage(), slugAvailableMessage(), slugIsYoursMessage() (+4 more)
...
Cohesion: 0.09
Nodes (41): CAL_BOOKING_LIST_FILTERS, CalBookingLifecycleStatus, CalBookingListFilter, CalBookingView, getCalBookingView(), hasRecurringBooking(), isAcceptedStatus(), isCancelledStatus() (+33 more)

### Community 64 - "@dnd-kit/sortable"
Cohesion: 0.07
Nodes (48): FaqSettingsForm(), initial, toDraftItems(), initial, SortableSuggestionChip(), StudioTab, SuggestionDraft, WorkspaceAgentStudio() (+40 more)
...
Cohesion: 0.10
Nodes (30): CreateMeetingTypeSheet(), DetailRow(), extractDescription(), extractLocationLabel(), formatDateTime(), formatDuration(), formatNotice(), initial (+22 more)

### Community 68 - "client.ts"
Cohesion: 0.05
Nodes (62): nowHm(), todayLabel(), buildMarkdown(), firstAttr(), identityLine(), instructionsForCtx(), languagePolicy(), faqSkill() (+54 more)
...
Cohesion: 0.36
Nodes (10): GET(), sanitizeIlike(), uniqueById(), markAllNotificationsReadAction(), markNotificationReadAction(), markAllNotificationsRead(), markNotificationRead(), createClient() (+2 more)
...
Cohesion: 0.60
Nodes (3): SetupPage(), SetupShell(), listWorkspaceMeetingTypes()

### Community 80 - "recharts"
Cohesion: 0.21
Nodes (22): AccountActionState, updateAccountNameAction(), LeadActionState, requireWorkspace(), updateLeadNotesAction(), updateLeadStatusAction(), acceptWorkspaceInviteAction(), createWorkspaceInvite() (+14 more)
...
Cohesion: 0.14
Nodes (19): signOut(), InviteAcceptPanel(), AccountProfileForm(), absoluteOrigin(), SettingsPage(), InvitePage(), metadata, Params (+11 more)
...
Cohesion: 0.21
Nodes (12): AccountPage(), BookingsPage(), ConversationsPage(), HelpPage(), LeadsPage(), DashboardPage(), daysAgoIso(), startOfTodayIso() (+4 more)

### Community 124 - "markdown-link.tsx"
Cohesion: 0.21
Nodes (10): EmbedSnippet(), EmbedDashboardPage(), BookingLiveBanner(), useDashboardBookingPath(), DashboardShellChrome(), DashboardShell(), SiteHeader(), SidebarInset() (+2 more)

### Community 126 - "20260723000005_leads_status.sql"
Cohesion: 0.09
Nodes (23): ai, @ai-sdk/anthropic, @ai-sdk/google, @dnd-kit/modifiers, lucide-react, dependencies, ai, @ai-sdk/anthropic (+15 more)

### Community 128 - "@supabase/ssr"
Cohesion: 0.33
Nodes (10): signIn(), signUp(), AUTH_ERROR_CODE, AuthErrorCode, AuthErrorContext, formatAuthError(), MESSAGE_MATCHERS, authErrorMessage() (+2 more)

### Community 132 - "@tailwindcss/postcss"
Cohesion: 0.22
Nodes (7): AuthState, AuthShell(), initial, LoginForm(), RainbowButton, RainbowButtonProps, rainbowButtonVariants
...
Cohesion: 0.12
Nodes (24): ChatUser, getInitials(), NavUser(), formatWhen(), NotificationsBell(), Avatar(), AvatarBadge(), AvatarFallback() (+16 more)
...
Cohesion: 0.26
Nodes (20): execute(), execute(), execute(), execute(), activeBooking(), AgentAuthBag, assertBookingChangeAllowed(), findClaimableBookings() (+12 more)
...
Cohesion: 0.10
Nodes (26): VirtualConversation(), AnalyticsTrendChart(), ChartAreaInteractive(), chartData, DataTable(), TableCellViewer(), ChartConfig, ChartContainer() (+18 more)
...
## Knowledge Gaps
- **1143 isolated node(s):** `deploy-codex.sh script`, `deploy.sh script`, `EveAuth`, `AgentStatus`, `ThreadBootstrap` (+1138 more)
...
- **Why does `cn()` connect `prompt-input.tsx` to `calcom.ts`, `message.tsx`, `code-block.tsx`, `@tailwindcss/postcss`, `chart.tsx`, `createClient`, `landing-page.tsx`, `sidebar.tsx`, `data-table.tsx`, `utils.ts`, `data-table.tsx`, `command.tsx`, `chain-of-thought.tsx`, `login-form.tsx`, `reasoning.tsx`, `conversation.tsx`, `workspace.ts`, `bookings-table.tsx`, `@dnd-kit/sortable`, `@gsap/react`, `getSessionWorkspaceId`, `next-themes`, `@radix-ui/react-use-controllable-state`, `eve.ts`, `use-stick-to-bottom`, `next-themes`, `markdown-link.tsx`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `dependencies` connect `20260723000005_leads_status.sql` to `@ai-sdk/google`, `@tabler/icons-react`, `class-variance-authority`, `scripts`, `next`, `landing-page.tsx`, `react-is`, `@ai-sdk/anthropic`, `@radix-ui/react-use-controllable-state`, `toggle-group.tsx`, `Smoke Checklist`, `@streamdown/cjk`, `@shikijs/engine-oniguruma`, `@streamdown/mermaid`, `badge.tsx`, `slugify`, `vaul`, `meeting-types-form.tsx`, `20260722000008_bookings_list_status.sql`, `zod`, `nanoid`, `Booking Intake Skill`, `radix-ui`, `@shikijs/core`, `eve.ts`, `workspace-settings-form.tsx`, `tailwind-merge`, `badge.tsx`, `ai`, `@dnd-kit/modifiers`, `@streamdown/math`, `agent/actions.ts`, `lenis-provider.tsx`, `react-dom`, `@gsap/react`, `radix-ui`, `recharts`, `streamdown`, `@streamdown/mermaid`, `@tailwindcss/postcss`, `tw-animate-css`, `createClient`, `@streamdown/code`, `timezone-select.tsx`, `hover-card.tsx`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `react` connect `eve.ts` to `@dnd-kit/sortable`, `calcom.ts`, `@gsap/react`, `workspace.ts`, `createClient`, `shimmer.tsx`, `next-themes`, `utils.ts`, `data-table.tsx`, `data-table.tsx`, `login-form.tsx`, `markdown-link.tsx`, `20260723000005_leads_status.sql`?**
...
- **Should `prompt-input.tsx` be split into smaller, more focused modules?**
  _Cohesion score 0.027136431784107944 - nodes in this community are weakly interconnected._
