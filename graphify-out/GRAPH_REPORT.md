...
## Corpus Check
- 678 files · ~445,193 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3653 nodes · 7833 edges · 413 communities (190 shown, 223 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 65 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c50e706c`
...
## Communities (413 total, 223 thin omitted)
...
Cohesion: 0.07
Nodes (35): isInAppLink(), MarkdownLink(), normalizeChatLinkHref(), MessageActionProps, MessageActions(), MessageActionsProps, MessageBranch(), MessageBranchContent() (+27 more)
...
Cohesion: 0.21
Nodes (18): GET(), GET(), isAppError(), buildMessengerOAuthUrl(), exchangeCodeForUserToken(), exchangeForLongLivedUserToken(), getPagesForUser(), graphFetch() (+10 more)
...
Cohesion: 0.06
Nodes (51): LandingFooter(), LandingHeader(), LandingHero(), Container(), GhostButton(), LandingShell(), PrimaryButton(), ProductFrame() (+43 more)

### Community 9 - "sidebar.tsx"
Cohesion: 0.08
Nodes (33): CreateMeetingTypeSheet(), DetailRow(), extractDescription(), extractLocationLabel(), formatDateTime(), formatDuration(), formatNotice(), initial (+25 more)
...
Cohesion: 0.13
Nodes (26): authorize(), GET(), workspaceIdsForTick(), addCalendarDays(), BookingReminderSource, computeSchedule(), deferToQuietEnd(), effectiveLeadMinutes() (+18 more)
...
Cohesion: 0.07
Nodes (43): POST(), processEvent(), RELEVANT_EVENTS, verifySignature(), webhookToBookingItem(), isCancelledStatus(), normalizeCalApiStatus(), AvailableSlot (+35 more)

### Community 15 - "command.tsx"
Cohesion: 0.14
Nodes (22): initial, SortableSuggestionChip(), StudioTab, SuggestionDraft, WorkspaceAgentStudio(), looksLikeBulletList(), parseBulletLines(), parseServiceTags() (+14 more)
...
Cohesion: 0.14
Nodes (20): generatedFaqSchema, GenerateFaqDraftState, parseFaqItems(), saveFaqSettings(), mocks, APP_ERROR_CODE, AppErrorCode, AppError (+12 more)
...
Cohesion: 0.18
Nodes (31): execute(), execute(), execute(), execute(), execute(), activeBooking(), assertBookingChangeAllowed(), findClaimableBookings() (+23 more)
...
Cohesion: 0.23
Nodes (14): GET(), normalizeQuery(), uniqueById(), GET(), markAllNotificationsReadAction(), markNotificationReadAction(), formatWhen(), NotificationsBell() (+6 more)

### Community 32 - "20260722000008_bookings_list_status.sql"
Cohesion: 0.10
Nodes (29): CalConnectionCard(), Props, MessengerConnectionCard(), Props, Props, WebhookSecretCard(), hasText(), initial (+21 more)
...
Cohesion: 0.13
Nodes (25): GET(), parseCursor(), NotificationsPage(), formatWhen(), GroupFilter, NotificationsInbox(), severityClass(), ViewMode (+17 more)
...
Cohesion: 0.14
Nodes (18): DashboardLayout(), AppSidebar(), BookingLiveBanner(), DashboardBookingPathContext, DashboardBookingPathProvider(), useDashboardBookingPath(), DashboardCommand(), DashboardRoleContext (+10 more)
...
Cohesion: 0.07
Nodes (67): EveAuth, isHumanReplyMode(), withTenantAttributes(), POST(), GET(), Params, POST(), GET() (+59 more)
...
### Community 71 - "nanoid"
Cohesion: 0.15
Nodes (22): ActionResult, handBackAction(), requireStaff(), sendStaffMessageAction(), takeOverAction(), getWorkspaceChatSession(), replaceChatMessages(), upsertChatMessages() (+14 more)
...
Cohesion: 0.22
Nodes (8): "message.completed"(), sendTextToSession(), mocks, ChatSessionRow, chunkMessengerText(), sendMessengerText(), getMessengerCredentialsForWorkspace(), getZaloCredentialsForWorkspace()
...
Cohesion: 0.46
Nodes (7): AgentPage(), parseAgentReplyLocale(), parseAgentTone(), parseChatSuggestions(), mapFaqItems(), mapWorkspaceFaqRecord(), fetchWorkspaceFaqForUser()
...
Cohesion: 0.10
Nodes (21): GET(), AuthShell(), highlights, InviteAcceptPanel(), absoluteInviteUrl(), copyLink(), initial, WorkspaceTeamCard() (+13 more)

### Community 94 - "use-stick-to-bottom"
Cohesion: 0.13
Nodes (27): AuthState, forgotPassword(), resetPassword(), signIn(), signUp(), EmbedChat(), ForgotPasswordForm(), initial (+19 more)
...
Cohesion: 0.12
Nodes (31): BookingDetailSheet(), BookingRow, BookingsTable(), bookingTitle(), extractEndIso(), extractMeetingUrl(), formatDay(), formatTime() (+23 more)
...
Cohesion: 0.22
Nodes (22): updateAccountNameAction(), saveEmbedAllowedOrigins(), generateFaqDraftAction(), LeadActionState, requireWorkspace(), updateLeadNotesAction(), updateLeadStatusAction(), acceptWorkspaceInviteAction() (+14 more)
...
Cohesion: 0.06
Nodes (65): POST(), GET(), POST(), mapPolarStatus(), metaString(), POST(), VALID_PLAN_TIERS, validatePlanTier() (+57 more)

### Community 116 - "seed.sql"
Cohesion: 0.05
Nodes (46): AgentChat(), AgentChatInner(), AgentChatThread(), AgentStatus, encodePollCursor(), StatusDot(), ThreadBootstrap, ChatSessionDrawer() (+38 more)

### Community 117 - "app/layout.tsx"
Cohesion: 0.09
Nodes (33): generateMetadata(), PageProps, PublicBookingSlugPage(), confirmReminderOptOutAction(), UnsubscribeActionState, PageProps, ReminderUnsubscribePage(), initialState (+25 more)

### Community 123 - "leads-table.tsx"
Cohesion: 0.08
Nodes (46): VirtualConversation(), AiHealthPanel(), severityClass(), severityIcon(), AnalyticsTrendChart(), ChartAreaInteractive(), chartData, DataTable() (+38 more)

### Community 124 - "dashboard-access.ts"
Cohesion: 0.17
Nodes (18): signOut(), AccountProfileForm(), AccountPage(), BookingsPage(), HelpPage(), LeadsPage(), DashboardPage(), daysAgoIso() (+10 more)
...
Cohesion: 0.10
Nodes (30): EmbedSecurityState, EmbedPageClient(), HOW_BULLETS, initialSecurity, INSTALL_STEPS, PLATFORMS, Snippets, EmbedSnippet() (+22 more)

### Community 135 - "workspace-team-card.tsx"
Cohesion: 0.11
Nodes (46): addDaysYmd(), compareYmd(), nowHm(), todayLabel(), todayYmd(), toYmd(), buildHandoffContext(), buildMarkdown() (+38 more)
...
Cohesion: 0.07
Nodes (50): ChatUserMenu(), getInitials(), chartData, columns, schema, Avatar(), AvatarBadge(), AvatarFallback() (+42 more)
...
Cohesion: 0.14
Nodes (28): execute(), TimezoneSelect(), AgentAuthBag, ABBREV, cachedFormatter(), calendarDayInTimeZone(), formatInZone(), formatSlotForGuest() (+20 more)
...
Cohesion: 0.18
Nodes (14): FaqSettingsForm(), initial, toDraftItems(), faqTemplateContextFromWorkspace(), buildSettingsAgentPreview(), orNull(), SettingsPreviewDraft, FaqDraftItem (+6 more)
...
Cohesion: 0.21
Nodes (12): BillingPayClient(), PaymentStatus, BillingPayPage(), EmbedDashboardPage(), FaqPage(), SetupPage(), DashboardShell(), absoluteAppOrigin() (+4 more)
...
Cohesion: 0.17
Nodes (10): getChannelSession(), getOrCreateChannelSession(), touchChannelSession(), MessengerMessageEvent, MetaEntry, MetaMessagingEntry, MetaWebhookBody, parseMessengerEvents() (+2 more)
...
### Community 357 - "lenis"
Cohesion: 0.11
Nodes (20): AGENT_ABOUT_TEMPLATES, AGENT_HOURS_PRESETS, AGENT_INSTRUCTIONS_STARTERS, AgentAboutTemplate, AgentHoursPreset, AgentInstructionsStarter, FAQ_TEMPLATES, FaqTemplate (+12 more)
...
Cohesion: 0.10
Nodes (33): GET(), GET(), authorize(), POST(), buildCalOAuthAuthorizeUrl(), CAL_OAUTH_SCOPES, CalOAuthError, exchangeCodeForToken() (+25 more)

### Community 400 - "verify_booking_code.ts"
Cohesion: 0.25
Nodes (11): execute(), generateOtpDigits(), bookingOtpEmailCopy(), bookingReminderEmailCopy(), escapeAttr(), escapeHtml(), sendTransactionalEmail(), SendTransactionalEmailInput (+3 more)

### Community 411 - "invite-accept-panel.tsx"
Cohesion: 0.21
Nodes (24): createMeetingTypeAction(), mirrorRow(), revalidateMeetingTypePaths(), setAiBookingMeetingTypeAction(), setAiBookingOnWorkspace(), syncMeetingTypesAction(), completeSetupAction(), disconnectCalAction() (+16 more)

### Community 418 - "messenger-webhook.ts"
Cohesion: 0.19
Nodes (9): channel, onMessageCompleted(), chatMessageExists(), findChatSessionByEveSessionId(), parseZaloEvents(), timingSafeEqual(), toEvent(), verifyZaloSignature() (+1 more)

## Knowledge Gaps
- **1441 isolated node(s):** `deploy-codex.sh script`, `deploy.sh script`, `npx`, `@dreamtree-org/graphify`, `EveAuth` (+1436 more)
...
- **Why does `cn()` connect `chat-sessions.ts` to `prompt-input.tsx`, `message.tsx`, `code-block.tsx`, `conversation-detail-sheet.tsx`, `landing-page.tsx`, `sidebar.tsx`, `eve-logo.tsx`, `data-table.tsx`, `book_appointment.ts`, `command.tsx`, `tool.tsx`, `layout.tsx`, `models.ts`, `invite-accept-panel.tsx`, `conversation.tsx`, `20260722000008_bookings_list_status.sql`, `dependencies`, `20260722000004_workspace_faq_sections.sql`, `@dnd-kit/modifiers`, `radix-ui`, `app/layout.tsx`, `badge.tsx`, `use-stick-to-bottom`, `next-themes`, `workspace-agent-studio.tsx`, `seed.sql`, `leads-table.tsx`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `react` connect `leads-table.tsx` to `20260722000008_bookings_list_status.sql`, `dependencies`, `next-themes`, `workspace-agent-studio.tsx`, `conversation-detail-sheet.tsx`, `landing-page.tsx`, `data-table.tsx`, `book_appointment.ts`, `tool.tsx`, `seed.sql`, `app/layout.tsx`, `invite-accept-panel.tsx`, `conversation.tsx`, `20260723000005_leads_status.sql`, `@dnd-kit/modifiers`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `dependencies` connect `20260723000005_leads_status.sql` to `workspace-secrets.ts`, `@shikijs/engine-oniguruma`, `slugify`, `class-variance-authority`, `app/layout.tsx`, `@streamdown/code`, `next-themes`, `posthog-node`, `landing-page.tsx`, `use-stick-to-bottom`, `@vvo/tzdb`, `@tabler/icons-react`, `Smoke Checklist`, `@streamdown/cjk`, `@dnd-kit/sortable`, `@dnd-kit/modifiers`, `react-is`, `@dnd-kit/core`, `nanoid`, `next-intl`, `@tailwindcss/postcss`, `@ai-sdk/google`, `@dnd-kit/sortable`, `@vercel/connect`, `ai`, `@dnd-kit/modifiers`, `@dnd-kit/core`, `motion`, `embed-page-client.tsx`, `@shikijs/engine-javascript`, `write_file.ts`, `recharts`, `@dnd-kit/modifiers`, `@dnd-kit/utilities`, `class-variance-authority`, `lucide-react`, `sonner`, `streamdown`, `@dnd-kit/core`, `tailwindcss`, `signOut`, `@tabler/icons-react`, `leads-table.tsx`, `@shikijs/core`, `particles.tsx`?**
