...
## Corpus Check
- 566 files · ~351,978 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3037 nodes · 6022 edges · 388 communities (177 shown, 211 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 54 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c92d6347`
...
4. `appErrorMessage()` - 47 edges
5. `Button()` - 38 edges
6. `react` - 34 edges
7. `getDashboardUser()` - 32 edges
8. `formatDbError()` - 32 edges
9. `requireOwnerWorkspace()` - 27 edges
10. `APP_ERROR_CODE` - 25 edges
...
- `generateMetadata()` --calls--> `getPublicBookingWorkspace()`  [EXTRACTED]
  app/b/[slug]/page.tsx → lib/workspace.ts
...
## Communities (388 total, 211 thin omitted)
...
Cohesion: 0.06
Nodes (10): ToolResult, CheckResult, FilterOp, getMockAdminClient(), MockAdminClient, OrderOp, QueryBuilder, resetSupabaseMock() (+2 more)
...
Cohesion: 0.14
Nodes (28): GET(), parseCursor(), GET(), sanitizeIlike(), uniqueById(), markAllNotificationsReadAction(), markNotificationReadAction(), NotificationsPage() (+20 more)
...
Cohesion: 0.11
Nodes (21): Faq(), FAQ_KEYS, FeatureMoments(), FinalCta(), Integrations(), LOGOS, LogoStrip(), MOMENT_KEYS (+13 more)
...
Cohesion: 0.08
Nodes (38): DashboardCommandContext, DashboardCommandContextValue, DashboardCommandProvider(), useDashboardCommand(), DashboardCommand(), NavMain(), NavMainGroup, NavMainItem (+30 more)
...
Cohesion: 0.08
Nodes (36): BookingHit, LeadHit, BreadcrumbEllipsis(), BreadcrumbItem(), BreadcrumbLink(), BreadcrumbList(), BreadcrumbPage(), BreadcrumbSeparator() (+28 more)
...
Cohesion: 0.06
Nodes (69): POST(), GET(), Params, POST(), GET(), Params, PATCH(), GET() (+61 more)
...
Cohesion: 0.13
Nodes (25): initial, SortableSuggestionChip(), StudioTab, SuggestionDraft, WorkspaceAgentStudio(), HOW_BULLETS, initialSecurity, INSTALL_STEPS (+17 more)

### Community 24 - "models.ts"
Cohesion: 0.22
Nodes (16): AgentPage(), FaqPage(), MeetingTypesPage(), SetupPage(), DashboardShell(), parseChatSuggestions(), canAccessDashboardPath(), DASHBOARD_PATH (+8 more)

### Community 25 - "login-form.tsx"
Cohesion: 0.05
Nodes (70): AnalyticsPage(), VirtualConversation(), AiHealthPanel(), severityClass(), severityIcon(), AnalyticsTrendChart(), ChartAreaInteractive(), chartData (+62 more)
...
Cohesion: 0.13
Nodes (35): execute(), isLongTreatmentIntent(), nextStatusOnLog(), normalizeText(), authorize(), GET(), workspaceIdsForTick(), issueManageLink() (+27 more)

### Community 32 - "20260722000008_bookings_list_status.sql"
Cohesion: 0.13
Nodes (24): AgentChat(), AgentChatThread(), EmbedChat(), cookieNameFor(), LocaleCtx, LocaleKind, LocaleProvider(), LocaleToggle() (+16 more)
...
Cohesion: 0.11
Nodes (25): confirmReminderOptOutAction(), UnsubscribeActionState, PageProps, ReminderUnsubscribePage(), initialState, UnsubscribeConfirmForm(), addCalendarDays(), BookingReminderSource (+17 more)
...
Cohesion: 0.33
Nodes (9): signIn(), signUp(), formatAuthError(), authErrorMessage(), isPublicSignupOpen(), isPilotBookingLive(), config, isNextFlightRequest() (+1 more)
...
Cohesion: 0.08
Nodes (43): rowView(), CAL_BOOKING_LIST_FILTERS, CAL_BOOKING_VIEWS, CalBookingLifecycleStatus, CalBookingListFilter, CalBookingView, getCalBookingView(), getCalBookingViewLabel() (+35 more)
...
Cohesion: 0.18
Nodes (29): execute(), execute(), execute(), execute(), execute(), activeBooking(), assertBookingChangeAllowed(), findClaimableBookings() (+21 more)
...
### Community 71 - "nanoid"
Cohesion: 0.27
Nodes (8): generateMetadata(), PageProps, PublicBookingSlugPage(), StripManageLinkParam(), ANALYTICS_EVENT, AnalyticsEvent, getClient(), trackServer()
...
Cohesion: 0.11
Nodes (18): 1. AI-first booking flow hoàn chỉnh, 2. Multi-tenant đúng chuẩn, 3. Embed script — distribution channel, 4. Cost-first model routing, 5. i18n sẵn — EN/VI, 6. Analytics + monitoring, Blockers — Phải làm trước khi bán, Chiến lược ra thị trường (+10 more)

### Community 76 - "faq-settings-form.tsx"
Cohesion: 0.18
Nodes (15): ChatPage(), LandingPage(), EmbedPage(), metadata, PageProps, HomePage(), appOrigin(), EmbedSnippetPlatform (+7 more)

### Community 78 - "@radix-ui/react-use-controllable-state"
Cohesion: 0.32
Nodes (6): InvitePage(), metadata, Params, SignupForm(), SignupPage(), getInvitePreview()

### Community 79 - "appErrorMessage"
Cohesion: 0.18
Nodes (19): execute(), AdminClient, bumpAttemptLock(), checkAttemptLock(), execute(), markBookingVerified(), bookingCodesEqual(), generateOtpDigits() (+11 more)

### Community 80 - "recharts"
Cohesion: 0.05
Nodes (57): FaqSettingsForm(), initial, toDraftItems(), AGENT_ABOUT_TEMPLATES, AGENT_HOURS_PRESETS, AGENT_INSTRUCTIONS_STARTERS, AgentAboutTemplate, AgentHoursPreset (+49 more)
...
Cohesion: 0.05
Nodes (100): InviteAcceptPanel(), MeetingTypesForm(), hasText(), initial, NAV, SlugStatus, WorkspaceSettingsForm(), absoluteInviteUrl() (+92 more)
...
Cohesion: 0.18
Nodes (22): addDaysYmd(), compareYmd(), nowHm(), todayLabel(), todayYmd(), toYmd(), buildMarkdown(), firstAttr() (+14 more)
...
Cohesion: 0.23
Nodes (9): signOut(), AccountProfileForm(), initial, AccountActionState, updateAccountNameAction(), AccountPage(), getInitials(), NavUser() (+1 more)

### Community 124 - "nanoid"
Cohesion: 0.25
Nodes (11): BookingsPage(), ConversationsPage(), HelpPage(), LeadsPage(), DashboardPage(), daysAgoIso(), startOfTodayIso(), getDashboardUser() (+3 more)
...
Cohesion: 0.13
Nodes (27): execute(), TimezoneSelect(), TimezoneSelectProps, Popover(), PopoverContent(), PopoverTrigger(), AgentAuthBag, resolveReminderTimeZone() (+19 more)
...
Cohesion: 0.17
Nodes (14): DashboardLayout(), AppSidebar(), BookingLiveBanner(), DashboardBookingPathContext, DashboardBookingPathProvider(), useDashboardBookingPath(), DashboardRoleContext, DashboardRoleProvider() (+6 more)
...
Cohesion: 0.08
Nodes (28): AuthState, AgentStatus, StatusDot(), ThreadBootstrap, AuthShell(), highlights, ChatUser, initial (+20 more)
...
Cohesion: 0.12
Nodes (23): ChatSessionDrawer(), ChatSessionSidebar(), ChatSessionsToggle(), ChatUser, WorkspaceBookingPage(), ConversationDetailSheet(), ConversationsTable(), formatWhen() (+15 more)
...
## Knowledge Gaps
- **1220 isolated node(s):** `ToolResult`, `CheckResult`, `name`, `version`, `type` (+1215 more)
...
- **Why does `cn()` connect `command.tsx` to `prompt-input.tsx`, `@shikijs/engine-oniguruma`, `message.tsx`, `code-block.tsx`, `@shikijs/engine-oniguruma`, `createClient`, `tailwindcss`, `landing-page.tsx`, `agent-chat.tsx`, `sidebar.tsx`, `data-table.tsx`, `utils.ts`, `data-table.tsx`, `chain-of-thought.tsx`, `tool.tsx`, `agent-message.tsx`, `layout.tsx`, `login-form.tsx`, `reasoning.tsx`, `20260722000008_bookings_list_status.sql`, `workspace.ts`, `react`, `@gsap/react`, `client.ts`, `@radix-ui/react-use-controllable-state`, `@shikijs/core`, `workspace-settings-form.tsx`, `use-stick-to-bottom`, `workspace-secrets.ts`, `app/layout.tsx`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **Why does `dependencies` connect `20260723000005_leads_status.sql` to `@tabler/icons-react`, `class-variance-authority`, `next`, `landing-page.tsx`, `chat-sessions.ts`, `Smoke Checklist`, `@ai-sdk/anthropic`, `chart.tsx`, `badge.tsx`, `slugify`, `meeting-types/actions.ts`, `login-form.tsx`, `meeting-types-form.tsx`, `manage-link.ts`, `zod`, `@dnd-kit/sortable`, `markdown-link.tsx`, `radix-ui`, `nanoid`, `badge.tsx`, `privacy/page.tsx`, `@vercel/connect`, `ai`, `@dnd-kit/modifiers`, `@streamdown/math`, `@sentry/nextjs`, `lenis-provider.tsx`, `@shikijs/engine-oniguruma`, `@gsap/react`, `@streamdown/cjk`, `radix-ui`, `recharts`, `streamdown`, `@dnd-kit/utilities`, `@tailwindcss/postcss`, `tw-animate-css`, `vaul`, `@supabase/supabase-js`, `createClient`, `tailwindcss`, `ai`, `timezone-select.tsx`, `react-dom`, `hover-card.tsx`, `particles.tsx`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `react` connect `login-form.tsx` to `20260722000008_bookings_list_status.sql`, `@shikijs/engine-oniguruma`, `tailwindcss`, `createClient`, `nanoid`, `data-table.tsx`, `utils.ts`, `workspace-secrets.ts`, `tool.tsx`, `workspace-settings-form.tsx`, `20260723000005_leads_status.sql`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **What connects `ToolResult`, `CheckResult`, `name` to the rest of the system?**
