# Graph Report - eve  (2026-07-30)

## Corpus Check
- 548 files · ~344,120 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2947 nodes · 6045 edges · 378 communities (170 shown, 208 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 54 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7bcfe51e`
...
4. `appErrorMessage()` - 51 edges
5. `Button()` - 38 edges
6. `react` - 34 edges
7. `getDashboardUser()` - 32 edges
8. `formatDbError()` - 32 edges
9. `APP_ERROR_CODE` - 27 edges
10. `requireOwnerWorkspace()` - 27 edges
...
## Communities (378 total, 208 thin omitted)
...
Cohesion: 0.12
Nodes (21): AgentChatInner(), AgentChatThread(), AgentStatus, StatusDot(), ThreadBootstrap, ChatSessionDrawer(), ChatSessionSidebar(), ChatSessionsToggle() (+13 more)
...
Cohesion: 0.08
Nodes (32): LandingFooter(), LandingHeader(), LandingHero(), LandingPage(), Container(), GhostButton(), LandingShell(), PrimaryButton() (+24 more)
...
Cohesion: 0.08
Nodes (43): NavMain(), NavMainGroup, NavMainItem, NavSecondaryItem, BreadcrumbEllipsis(), BreadcrumbItem(), BreadcrumbLink(), BreadcrumbList() (+35 more)
...
Cohesion: 0.11
Nodes (20): TimezoneSelectProps, Command(), CommandDialog(), CommandEmpty(), CommandGroup(), CommandInput(), CommandItem(), CommandList() (+12 more)
...
Cohesion: 0.07
Nodes (59): withTenantAttributes(), POST(), GET(), Params, POST(), GET(), Params, PATCH() (+51 more)
...
Cohesion: 0.20
Nodes (15): claimVisitorSessions(), parseServiceMode(), authAttr(), getDefaultWorkspaceId(), getPilotWorkspaceId(), getPublicBookingWorkspaceById(), getWorkspaceById(), isPilotBookingLive() (+7 more)

### Community 24 - "models.ts"
Cohesion: 0.28
Nodes (10): EmbedPageClient(), EmbedDashboardPage(), SettingsPage(), absoluteAppOrigin(), buildEmbedSnippets(), formatEmbedSiteId(), listPendingInvites(), listWorkspaceMembers() (+2 more)
...
Cohesion: 0.18
Nodes (25): execute(), isLongTreatmentIntent(), nextStatusOnLog(), normalizeText(), authorize(), GET(), workspaceIdsForTick(), fetchAllCalBookings() (+17 more)
...
Cohesion: 0.13
Nodes (20): AuthState, signIn(), signUp(), initial, SignupForm(), RainbowButton, RainbowButtonProps, rainbowButtonVariants (+12 more)
...
Cohesion: 0.11
Nodes (35): MeetingTypesForm(), createMeetingTypeAction(), mirrorRow(), revalidateMeetingTypePaths(), setAiBookingOnWorkspace(), syncMeetingTypesAction(), MeetingTypesPage(), AvailableSlot (+27 more)

### Community 64 - "@dnd-kit/sortable"
Cohesion: 0.12
Nodes (26): initial, SortableSuggestionChip(), StudioTab, SuggestionDraft, WorkspaceAgentStudio(), looksLikeBulletList(), parseBulletLines(), parseServiceTags() (+18 more)
...
### Community 71 - "nanoid"
Cohesion: 0.24
Nodes (10): generateMetadata(), PageProps, PublicBookingSlugPage(), ChatPage(), HomePage(), StripManageLinkParam(), getClient(), trackServer() (+2 more)
...
Cohesion: 0.19
Nodes (18): parseAgentReplyLocale(), buildSettingsAgentPreview(), orNull(), SettingsPreviewDraft, AiBookingEventType, aiBookableSummaryLine(), buildBookingFaqSummary(), contactLine() (+10 more)

### Community 81 - "@shikijs/core"
Cohesion: 0.09
Nodes (25): initial, initial, DashboardRefreshButton(), ShimmerButton, ShimmerButtonProps, SiteHeader(), TITLE_BY_PATH, Button() (+17 more)
...
Cohesion: 0.15
Nodes (17): optionalText(), parseSuggestionsFromForm(), saveWorkspaceAgent(), AGENT_REPLY_LOCALE_OPTIONS, AGENT_REPLY_LOCALES, AGENT_TONE_OPTIONS, AGENT_TONES, AgentReplyLocale (+9 more)
...
Cohesion: 0.20
Nodes (16): rowView(), CAL_BOOKING_LIST_FILTERS, CAL_BOOKING_VIEWS, CalBookingLifecycleStatus, CalBookingListFilter, CalBookingView, getCalBookingView(), getCalBookingViewLabel() (+8 more)
...
### Community 97 - "lenis"
Cohesion: 0.20
Nodes (11): FaqSettingsForm(), initial, toDraftItems(), saveFaqSettings(), FAQ_TEMPLATES, FaqTemplate, FaqTemplateContext, faqTemplateContextFromWorkspace() (+3 more)

### Community 99 - "next-themes"
Cohesion: 0.05
Nodes (84): InviteAcceptPanel(), hasText(), initial, NAV, SlugStatus, WorkspaceSettingsForm(), absoluteInviteUrl(), copyLink() (+76 more)

### Community 100 - "meeting-types-form.tsx"
Cohesion: 0.17
Nodes (25): addDaysYmd(), compareYmd(), nowHm(), todayLabel(), todayYmd(), toYmd(), buildMarkdown(), firstAttr() (+17 more)
...
Cohesion: 0.33
Nodes (5): signOut(), AccountProfileForm(), AccountActionState, updateAccountNameAction(), SetupShell()

### Community 124 - "nanoid"
Cohesion: 0.18
Nodes (17): AccountPage(), AnalyticsPage(), BookingsPage(), ConversationsPage(), HelpPage(), LeadsPage(), DashboardPage(), daysAgoIso() (+9 more)
...
Cohesion: 0.27
Nodes (14): execute(), authAttr(), ABBREV, formatInZone(), formatSlotForGuest(), isValidIanaTimeZone(), normalizeIanaTimeZone(), PLACE (+6 more)

### Community 129 - "@shikijs/engine-oniguruma"
Cohesion: 0.08
Nodes (45): HOW_BULLETS, initialSecurity, INSTALL_STEPS, PLATFORMS, Snippets, EmbedSnippet(), VirtualConversation(), AiHealthPanel() (+37 more)
...
Cohesion: 0.38
Nodes (5): DashboardLayout(), DashboardBookingPathContext, DashboardBookingPathProvider(), DashboardRoleProvider(), readDashboardLocale()
...
Cohesion: 0.13
Nodes (21): getInitials(), formatWhen(), NotificationsBell(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount() (+13 more)
...
Cohesion: 0.32
Nodes (10): AgentPage(), FaqPage(), SetupPage(), DASHBOARD_PATH, DashboardPath, isOwnerOnlyPath(), OWNER_ONLY_PATHS, assertOwnerPage() (+2 more)
...
Cohesion: 0.16
Nodes (19): AppSidebar(), BookingLiveBanner(), useDashboardBookingPath(), BookingHit, DashboardCommandContext, DashboardCommandContextValue, DashboardCommandProvider(), useDashboardCommand() (+11 more)

### Community 358 - "notifications/route.ts"
Cohesion: 0.24
Nodes (14): GET(), sanitizeIlike(), uniqueById(), syncBookingsAction(), SyncBookingsState, markAllNotificationsReadAction(), markNotificationReadAction(), BookingsSyncButton() (+6 more)

### Community 371 - "workspace-secrets.ts"
Cohesion: 0.11
Nodes (29): ChatUser, ConversationDetailSheet(), ConversationsTable(), formatWhen(), outcomeBadgeClass(), outcomeLabel(), ViewId, VIEWS (+21 more)
...
## Knowledge Gaps
- **1193 isolated node(s):** `deploy-codex.sh script`, `deploy.sh script`, `EveAuth`, `AgentStatus`, `ThreadBootstrap` (+1188 more)
...
- **Why does `cn()` connect `data-table.tsx` to `prompt-input.tsx`, `calcom.ts`, `@shikijs/engine-oniguruma`, `code-block.tsx`, `message.tsx`, `createClient`, `landing-page.tsx`, `agent-chat.tsx`, `sidebar.tsx`, `utils.ts`, `data-table.tsx`, `command.tsx`, `chain-of-thought.tsx`, `reasoning.tsx`, `20260722000008_bookings_list_status.sql`, `workspace.ts`, `react`, `20260722000004_workspace_faq_sections.sql`, `bookings-table.tsx`, `@dnd-kit/modifiers`, `@dnd-kit/sortable`, `@gsap/react`, `client.ts`, `@shikijs/core`, `use-stick-to-bottom`, `next-themes`, `graphify-session.mjs`, `workspace-secrets.ts`, `app/layout.tsx`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **Why does `react` connect `@shikijs/engine-oniguruma` to `20260722000008_bookings_list_status.sql`, `calcom.ts`, `next-themes`, `graphify-session.mjs`, `workspace.ts`, `createClient`, `nanoid`, `data-table.tsx`, `utils.ts`, `workspace-secrets.ts`, `20260723000005_leads_status.sql`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `dependencies` connect `20260723000005_leads_status.sql` to `@shikijs/engine-oniguruma`, `@tabler/icons-react`, `class-variance-authority`, `@tailwindcss/postcss`, `scripts`, `next`, `chat-sessions.ts`, `Smoke Checklist`, `@ai-sdk/anthropic`, `chart.tsx`, `agent/actions.ts`, `badge.tsx`, `slugify`, `meeting-types/actions.ts`, `meeting-types-form.tsx`, `manage-link.ts`, `zod`, `markdown-link.tsx`, `radix-ui`, `nanoid`, `badge.tsx`, `privacy/page.tsx`, `@vercel/connect`, `ai`, `@dnd-kit/modifiers`, `@streamdown/math`, `@sentry/nextjs`, `lenis-provider.tsx`, `@shikijs/engine-oniguruma`, `@gsap/react`, `@streamdown/cjk`, `radix-ui`, `recharts`, `streamdown`, `@dnd-kit/utilities`, `@tailwindcss/postcss`, `tw-animate-css`, `vaul`, `@supabase/supabase-js`, `createClient`, `tailwindcss`, `timezone-select.tsx`, `react-dom`, `hover-card.tsx`, `particles.tsx`?**
