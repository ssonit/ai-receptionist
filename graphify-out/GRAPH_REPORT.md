...
## Summary
- 3494 nodes · 7437 edges · 394 communities (182 shown, 212 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 63 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a5864812`
...
## Communities (394 total, 212 thin omitted)

### Community 0 - "prompt-input.tsx"
Cohesion: 0.02
Nodes (88): AttachmentsContext, captureScreenshot(), convertBlobUrlToDataUrl(), LocalAttachmentsContext, LocalReferencedSourcesContext, PromptInput(), PromptInputActionAddAttachments(), PromptInputActionAddAttachmentsProps (+80 more)
...
Cohesion: 0.06
Nodes (42): LandingFooter(), LandingHeader(), LandingHero(), Container(), GhostButton(), LandingShell(), PrimaryButton(), ProductFrame() (+34 more)

### Community 9 - "sidebar.tsx"
Cohesion: 0.12
Nodes (31): GET(), parseCursor(), GET(), normalizeQuery(), uniqueById(), GET(), markAllNotificationsReadAction(), markNotificationReadAction() (+23 more)
...
Cohesion: 0.07
Nodes (42): AnalyticsTrendChart(), ChartAreaInteractive(), CopyBookingLink(), useDashboardCommand(), DashboardCommand(), DataTable(), TableCellViewer(), NavMain() (+34 more)
...
Cohesion: 0.16
Nodes (24): execute(), TimezoneSelect(), ABBREV, cachedFormatter(), formatInZone(), isValidIanaTimeZone(), normalizeIanaTimeZone(), parseServiceMode() (+16 more)

### Community 15 - "command.tsx"
Cohesion: 0.16
Nodes (20): cookieNameFor(), LocaleCtx, LocaleKind, LocaleProvider(), LocaleToggle(), readCookie(), useAppLocale(), writeCookie() (+12 more)
...
Cohesion: 0.07
Nodes (52): initial, SortableSuggestionChip(), StudioTab, SuggestionDraft, WorkspaceAgentStudio(), EmbedSecurityState, HOW_BULLETS, initialSecurity (+44 more)
...
Cohesion: 0.05
Nodes (48): AgentChat(), AgentChatInner(), AgentChatThread(), AgentStatus, StatusDot(), ThreadBootstrap, ChatSessionDrawer(), ChatSessionSidebar() (+40 more)
...
Cohesion: 0.18
Nodes (34): execute(), execute(), execute(), execute(), execute(), MeetingTypesPage(), activeBooking(), AgentAuthBag (+26 more)
...
Cohesion: 0.19
Nodes (28): POST(), GET(), Params, POST(), GET(), Params, PATCH(), GET() (+20 more)
...
Cohesion: 0.21
Nodes (17): GET(), GET(), GET(), buildCalOAuthAuthorizeUrl(), createOAuthState(), getStateSecret(), OAuthStatePayload, parseOAuthState() (+9 more)
...
Cohesion: 0.16
Nodes (17): AccountPage(), AnalyticsPage(), BookingsPage(), HelpPage(), LeadsPage(), DashboardPage(), daysAgoIso(), startOfTodayIso() (+9 more)
...
### Community 46 - "react"
Cohesion: 0.06
Nodes (65): addDaysYmd(), compareYmd(), nowHm(), todayLabel(), todayYmd(), toYmd(), buildMarkdown(), firstAttr() (+57 more)
...
Cohesion: 0.18
Nodes (9): "message.completed"(), MessengerMessageEvent, MetaEntry, MetaMessagingEntry, MetaWebhookBody, parseMessengerEvents(), verifyMessengerSignature(), verifyWebhookToken() (+1 more)
...
Cohesion: 0.06
Nodes (57): POST(), processEvent(), RELEVANT_EVENTS, verifySignature(), webhookToBookingItem(), CAL_BOOKING_LIST_FILTERS, CAL_BOOKING_VIEWS, CalBookingLifecycleStatus (+49 more)
...
### Community 71 - "nanoid"
Cohesion: 0.20
Nodes (22): CalConnectionCard(), Props, WorkspaceSettingsForm(), checkWorkspaceSlugAvailable(), completeSetupAction(), disconnectCalAction(), finishSetupAction(), saveCalApiKeyAction() (+14 more)
...
Cohesion: 0.14
Nodes (16): DashboardLayout(), BookingLiveBanner(), DashboardBookingPathContext, DashboardBookingPathProvider(), useDashboardBookingPath(), DashboardCommandContext, DashboardCommandContextValue, DashboardCommandProvider() (+8 more)

### Community 77 - "radix-ui"
Cohesion: 0.23
Nodes (19): execute(), execute(), authorize(), GET(), workspaceIdsForTick(), logAgentToolEvent(), normalizeLeadUrgency(), findWorkspaceLead() (+11 more)

### Community 78 - "@radix-ui/react-use-controllable-state"
Cohesion: 0.20
Nodes (12): generatedFaqSchema, GenerateFaqDraftState, parseFaqItems(), saveFaqSettings(), APP_ERROR_CODE, AppErrorCode, AppError, faqItemInvalidMessage() (+4 more)
...
Cohesion: 0.29
Nodes (10): claimVisitorSessions(), createChatSession(), consumeManageLink(), ConsumeManageLinkResult, ensureVisitorIdOnResponse(), isVisitorId(), readVisitorIdFromRequest(), ensureVisitorId() (+2 more)

### Community 81 - "@shikijs/core"
Cohesion: 0.10
Nodes (27): Props, WebhookSecretCard(), hasText(), initial, NAV, SlugStatus, optionalText(), parseSuggestionsFromForm() (+19 more)
...
Cohesion: 0.13
Nodes (16): DashboardRefreshButton(), EveLogoContent(), EveLogoMark(), EveLogoProps, EveLogoSize, SIZE_PX, ShimmerButton, ShimmerButtonProps (+8 more)
...
Cohesion: 0.23
Nodes (11): GET(), CAL_OAUTH_SCOPES, CalOAuthError, exchangeCodeForToken(), getCalMeProfileWithToken(), isDefinitiveCalOAuthError(), OAuthTokenResponse, OAuthTokenStore (+3 more)
...
Cohesion: 0.22
Nodes (9): signOut(), AccountProfileForm(), AppSidebar(), getInitials(), NavUser(), SetupShell(), canAccessDashboardPath(), isOwnerOnlyPath() (+1 more)
...
Cohesion: 0.06
Nodes (48): AuthState, forgotPassword(), resetPassword(), signIn(), signUp(), confirmReminderOptOutAction(), UnsubscribeActionState, PageProps (+40 more)

### Community 133 - "data-table.tsx"
Cohesion: 0.43
Nodes (3): authorize(), POST(), getPilotWorkspaceId()

### Community 135 - "workspace-team-card.tsx"
Cohesion: 0.09
Nodes (18): channel, onMessageCompleted(), mocks, postHandler(), actorOwnsSession(), chatMessageExists(), ChatMessagesPage, ChatSessionRow (+10 more)
...
Cohesion: 0.19
Nodes (19): BillingPayClient(), PaymentStatus, AgentPage(), BillingPayPage(), EmbedPageClient(), EmbedDashboardPage(), FaqPage(), SettingsPage() (+11 more)

### Community 154 - "revealWebhookSecretAction"
Cohesion: 0.25
Nodes (14): MeetingTypesForm(), syncBookingsAction(), SyncBookingsState, createMeetingTypeAction(), mirrorRow(), revalidateMeetingTypePaths(), setAiBookingMeetingTypeAction(), setAiBookingOnWorkspace() (+6 more)
...
Cohesion: 0.19
Nodes (16): { refreshAccessToken }, seedOAuthWorkspace(), orDefault(), withWorkspaceAiDefaults(), ensureWebhookSecret(), generateWebhookSecret(), getCalAccessTokenForWorkspace(), getPublicBookingWorkspaceById() (+8 more)
...
## Knowledge Gaps
- **1359 isolated node(s):** `channel`, `mocks`, `ChatSessionStatus`, `ChatSessionRow`, `MessageCursor` (+1354 more)
...
- **Why does `cn()` connect `createClient` to `prompt-input.tsx`, `message.tsx`, `code-block.tsx`, `notifications-inbox.tsx`, `landing-page.tsx`, `sidebar.tsx`, `data-table.tsx`, `data-table.tsx`, `command.tsx`, `chain-of-thought.tsx`, `tool.tsx`, `layout.tsx`, `models.ts`, `revealWebhookSecretAction`, `20260722000008_bookings_list_status.sql`, `nanoid`, `faq-settings-form.tsx`, `@shikijs/core`, `workspace-settings-form.tsx`, `label.tsx`, `use-stick-to-bottom`, `next-themes`, `workspace-agent-studio.tsx`, `shimmer-button.tsx`, `grep.ts`, `timezone-select.tsx`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `react` connect `data-table.tsx` to `20260722000008_bookings_list_status.sql`, `workspace-agent-studio.tsx`, `nanoid`, `sidebar.tsx`, `meeting-types/actions.ts`, `faq-settings-form.tsx`, `data-table.tsx`, `command.tsx`, `tool.tsx`, `layout.tsx`, `models.ts`, `20260723000005_leads_status.sql`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `dependencies` connect `20260723000005_leads_status.sql` to `workspace-ai-defaults.ts`, `workspace-secrets.ts`, `slugify`, `class-variance-authority`, `@shikijs/engine-oniguruma`, `@streamdown/code`, `next-themes`, `posthog-node`, `landing-page.tsx`, `chat-sessions.ts`, `use-stick-to-bottom`, `data-table.tsx`, `@vvo/tzdb`, `Smoke Checklist`, `book_appointment.ts`, `@streamdown/cjk`, `@tabler/icons-react`, `@dnd-kit/sortable`, `@dnd-kit/modifiers`, `react-is`, `@dnd-kit/core`, `nanoid`, `agent/actions.ts`, `next-intl`, `next-themes`, `track.ts`, `@tailwindcss/postcss`, `instructions.ts`, `@dnd-kit/sortable`, `@vercel/connect`, `ai`, `@dnd-kit/modifiers`, `next`, `@dnd-kit/modifiers`, `recharts`, `write_file.ts`, `@dnd-kit/utilities`, `streamdown`, `lucide-react`, `@dnd-kit/core`, `tailwindcss`, `signOut`, `@shikijs/core`, `hover-card.tsx`, `particles.tsx`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **What connects `channel`, `mocks`, `ChatSessionStatus` to the rest of the system?**
...
- **Should `prompt-input.tsx` be split into smaller, more focused modules?**
  _Cohesion score 0.023366336633663366 - nodes in this community are weakly interconnected._
