...
describe.skipIf(!dbUp)("membership dual-write", () => {
  ...
  it("keeps profiles.role and workspace_members.role equal for the user it creates", async () => {
    ...
    // deliberately points a profile at one workspace and its membership at
    // another to prove which table RLS reads. That divergence is intentional
    // and outside the invariant this test is asserting.
